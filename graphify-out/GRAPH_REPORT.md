...
## Corpus Check
- 163 files · ~80,715 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 997 nodes · 1436 edges · 111 communities (77 shown, 34 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 97 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f577e821`
...
1. `COLORS` - 37 edges
2. `ThemeContext` - 30 edges
3. `AuthContext` - 21 edges
4. `JwtUtil` - 13 edges
5. `StatsService` - 12 edges
6. `HomeAggregatorService` - 10 edges
7. `KINETIC` - 10 edges
8. `formatNumberPtBR()` - 9 edges
9. `AuthService` - 8 edges
...
Cohesion: 0.06
Nodes (49): ForgotPasswordScreen(), Props, styles, Props, ResetPasswordScreen(), styles, Props, styles (+41 more)
...
Cohesion: 0.05
Nodes (10): WorkoutController, ExerciseSetLogRepository, WorkoutPlanRepository, PlanCycleSnapshotService, WorkoutService, DATA, Icons, INSIGHTS (+2 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (6): HomeController, of(), WorkoutSessionRepository, CommunityStatsService, HomeAggregatorService, WorkoutSessionService

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (22): Author, FeedPost(), Post, Props, styles, json(), getText(), RuntimeException (+14 more)
...
Cohesion: 0.08
Nodes (18): CardHeaderProps, chipStyles, ConsistencyCardProps, consistencyStyles, DeltaChipProps, InsightBlockProps, insightStyles, KpiData (+10 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (9): A, LoginScreen(), Props, styles, A, BiometricState, Props, SecurityState (+1 more)
...
Cohesion: 0.17
Nodes (17): AuthContextValue, AuthResult, CompleteOnboardingData, KineticUser, RememberedUser, isPublic, logoutUser(), original (+9 more)
...
Cohesion: 0.13
Nodes (10): cardS, chipS, emptyS, insightS, PlanEvolutionCardProps, rowS, T, MetricDeltaDTO (+2 more)
...
Cohesion: 0.14
Nodes (13): CommunityComparisonDTO, GenerateWorkoutRequest, HomeDashboardResponseDTO, RankingEntryDTO, StatsSummaryResponseDTO, UpdateWeightRequestDTO, UserProfileResponse, VolumeByMuscleGroupDTO (+5 more)
...
Cohesion: 0.2
Nodes (4): AuthController, api, setSignOutHandler(), getRefreshToken()
...
## Knowledge Gaps
- **299 isolated node(s):** `A`, `Ic`, `FAKE_USER`, `HK`, `MOCK` (+294 more)
...
- **Why does `COLORS` connect `Community 0` to `Community 1`, `Community 4`, `Community 38`, `Community 6`, `Community 53`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `of()` connect `Community 3` to `Community 4`, `Community 22`, `Community 7`?**
