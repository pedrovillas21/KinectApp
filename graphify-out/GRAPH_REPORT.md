...
## Corpus Check
- 286 files · ~141,561 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1585 nodes · 2506 edges · 195 communities (141 shown, 54 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 247 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0809809e`
...
4. `KINETIC` - 29 edges
5. `AuthContext` - 23 edges
6. `SocialController` - 22 edges
7. `of()` - 18 edges
8. `HomeAggregatorService` - 15 edges
9. `JwtUtil` - 14 edges
10. `StatsService` - 14 edges

## Surprising Connections (you probably didn't know these)
- `TrainerChatScreen()` --calls--> `avatarFallback()`  [EXTRACTED]
  KineticApp/src/screens/TrainerChatScreen.tsx → KineticApp/src/services/socialService.ts
- `ChatPanel()` --calls--> `useAuth()`  [EXTRACTED]
  kinetic-desktop/src/components/ChatPanel.tsx → kinetic-desktop/src/contexts/AuthContext.tsx
- `LoginPage()` --calls--> `useAuth()`  [EXTRACTED]
  kinetic-desktop/src/pages/LoginPage.tsx → kinetic-desktop/src/contexts/AuthContext.tsx
- `StudentsListPage()` --calls--> `useAuth()`  [EXTRACTED]
  kinetic-desktop/src/pages/StudentsListPage.tsx → kinetic-desktop/src/contexts/AuthContext.tsx
- `ProtectedRoute()` --calls--> `useAuth()`  [EXTRACTED]
  kinetic-desktop/src/routes/ProtectedRoute.tsx → kinetic-desktop/src/contexts/AuthContext.tsx

## Communities (195 total, 54 thin omitted)

### Community 0 - "Frontend Core & Auth UI"
Cohesion: 0.06
Nodes (51): A, BiometricState, Props, SecurityState, styles, ChatPanel(), Props, st (+43 more)
...
Cohesion: 0.07
Nodes (15): endDate(), fromString(), id(), insightTag(), previousEndDate(), previousStartDate(), startDate(), targetSessions() (+7 more)
...
Cohesion: 0.1
Nodes (27): INTENSITY_LABELS, INTENSITY_OPTIONS, Props, styles, Props, styles, useSquadStatus(), SocialScreen() (+19 more)

### Community 5 - "Home Screen & Evolution Modal"
Cohesion: 0.08
Nodes (25): AppHeader(), AppHeaderProps, styles, AdherenceCardProps, styles, getGreeting(), HomeGreeting(), HomeGreetingProps (+17 more)
...
Cohesion: 0.07
Nodes (20): AuthContextValue, DAYS_LABELS, GEN_STEPS, GOAL_API_MAP, GoalDef, GOALS, GoalType, LEVEL_API_MAP (+12 more)

### Community 9 - "Social Feed & Mock Data"
Cohesion: 0.08
Nodes (19): CardHeaderProps, CATEGORY_LABEL, chipStyles, ConsistencyCardProps, consistencyStyles, DeltaChipProps, InsightBlockProps, insightStyles (+11 more)

### Community 10 - "Exercise Logging DTOs"
Cohesion: 0.1
Nodes (16): Props, styles, Props, SerieCard(), SerieStatus, styles, useWorkoutPresence(), ActiveSessionScreen() (+8 more)

### Community 11 - "Community 11"
Cohesion: 0.12
Nodes (4): BaseController, ChatController, StudentTrainerController, WorkoutSessionController
...
Cohesion: 0.12
Nodes (13): CHART, DashboardTab(), formatKg(), nf, PERIODS, Props, st, tooltipStyle (+5 more)

### Community 15 - "Community 15"
Cohesion: 0.11
Nodes (14): Props, styles, Author, FeedPost(), Props, styles, IconName, IconProps (+6 more)
...
Cohesion: 0.17
Nodes (9): styles, AuthContext, OnboardingScreen(), styles, AppRoutes(), AuthContextShape, Drawer, Stack (+1 more)
...
Cohesion: 0.11
Nodes (5): BaseController, HomeController, StatsController, UserController, WorkoutController
...
Cohesion: 0.14
Nodes (10): Props, Props, st, st, Tab, st, inviteStudent(), listStudents() (+2 more)

### Community 26 - "Community 26"
Cohesion: 0.12
Nodes (14): styles, ValueLabelProps, WeeklyChartProps, CreatePostRequest, CreateStoryRequest, FeedAuthor, GenerateWorkoutRequest, PresenceStatus (+6 more)
...
Cohesion: 0.19
Nodes (5): AuthController, config, { getDefaultConfig }, path, RefreshToken
...
Cohesion: 0.16
Nodes (8): HeaderLogo(), Props, styles, styles, ThemeToggle(), ThemeContextValue, ThemeProvider(), App()
...
Cohesion: 0.14
Nodes (9): cardS, chipS, emptyS, insightS, PlanEvolutionCardProps, rowS, T, STATS_T (+1 more)

### Community 43 - "Community 43"
Cohesion: 0.19
Nodes (14): DeltaChip(), DeltaChip(), VolumeCard(), WeightCard(), StatsPeriodId, StatsPeriodOption, formatNumberPtBR(), formatSignedNumberPtBR() (+6 more)
...
Cohesion: 0.22
Nodes (11): 1.3. Rodar o backend com Docker, 2.1. Instalar dependências, 2.2. Configurar a URL da API, 2.3. Rodar o app, 2. Subindo o app mobile (`KineticApp`), Buildando em outro PC (passo a passo), code:bash (# 1. Garanta que o .env existe (mesma config da seção 1.1)), code:bash (docker compose up -d --build   # sobe em background (detache) (+3 more)
...
Cohesion: 0.22
Nodes (9): code:block10 (KinectApp/), code:bash (npm install), Estrutura do repositório, Fluxo rápido para testar localmente, Kinetic App, Notas, Pré-requisitos, Principais endpoints da API (+1 more)
...
Cohesion: 0.25
Nodes (7): CommunityComparisonDTO, MetricDeltaDTO, Page, VolumeByMuscleGroupDTO, VolumeSummaryDTO, WeightPointDTO, WeightSummaryDTO
...
## Knowledge Gaps
- **380 isolated node(s):** `HKT`, `EXERCICIOS`, `A`, `Ic`, `FAKE_USER` (+375 more)
...
- **Why does `Badge` connect `Stats Service & Periods` to `Stats & Dashboard Types`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `of()` connect `Community 13` to `Community 32`, `Community 33`, `Stats & Dashboard Types`, `Backend Auth & User Mgmt`, `Community 40`, `Community 11`, `Community 12`, `Community 45`, `Community 22`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `Post` connect `Community 12` to `Community 15`?**
