# Graph Report - KinectApp  (2026-06-17)

## Corpus Check
- 221 files · ~108,899 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1278 nodes · 1943 edges · 158 communities (116 shown, 42 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 168 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d6fa9a26`
...
Cohesion: 0.05
Nodes (34): A, LoginScreen(), Props, styles, A, BiometricState, Props, SecurityState (+26 more)
...
Cohesion: 0.08
Nodes (7): RefreshToken, OncePerRequestFilter, RefreshTokenRepository, JwtAuthenticationFilter, JwtUtil, AuthService, RefreshTokenService
...
Cohesion: 0.12
Nodes (25): ACTION_LABEL, Props, styles, useSquadStatus(), SocialScreen(), styles, acceptConnection(), createStory() (+17 more)
...
Cohesion: 0.1
Nodes (17): styles, EvolutionModalProps, styles, AuthContext, WorkoutPlanItem, AppRoutes(), AuthContextShape, Drawer (+9 more)
...
Cohesion: 0.1
Nodes (18): styles, ValueLabelProps, WeeklyChartProps, CreatePostRequest, CreateStoryRequest, FeedAuthor, GenerateWorkoutRequest, LogSessionRequestDTO (+10 more)
...
Cohesion: 0.12
Nodes (11): IconName, IconProps, INTENSITY_LABELS, INTENSITY_OPTIONS, Props, styles, Props, styles (+3 more)
...
Cohesion: 0.16
Nodes (8): PasswordRequirements(), Props, ReqProps, styles, AuthProvider(), ThemeContextValue, ThemeProvider(), App()
...
## Knowledge Gaps
- **331 isolated node(s):** `A`, `Ic`, `FAKE_USER`, `HK`, `MOCK` (+326 more)
...
- **Why does `of()` connect `Community 37` to `Stats & Dashboard Types`, `Stats Service & Periods`, `Workout Sessions & Community Stats`, `Community 45`, `Community 19`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `Post` connect `Community 45` to `Community 33`?**
