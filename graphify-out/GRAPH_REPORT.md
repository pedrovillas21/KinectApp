...
## Corpus Check
- 150 files · ~67,862 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 834 nodes · 1122 edges · 88 communities (62 shown, 26 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6b6818a1`
...
8. `UserService` - 8 edges
9. `Kinetic App` - 8 edges
...
Cohesion: 0.05
Nodes (43): styles, styles, styles, styles, styles, AppHeader(), AppHeaderProps, styles (+35 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (43): CardHeaderProps, chipStyles, ConsistencyCardProps, consistencyStyles, DeltaChip(), DeltaChipProps, InsightBlockProps, insightStyles (+35 more)
...
Cohesion: 0.05
Nodes (37): AuthContextValue, AuthResult, CompleteOnboardingData, KineticUser, WorkoutPlanItem, AuthContextValue, DAYS_LABELS, GEN_STEPS (+29 more)
...
Cohesion: 0.09
Nodes (5): UserController, UserLoginStreakRepository, WeightHistoryRepository, WorkoutExecutionLogRepository, UserService
...
- **Why does `AuthService` connect `Community 4` to `Community 12`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `UserRepository` connect `Community 12` to `Community 4`?**
