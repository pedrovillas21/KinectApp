...
## Summary
- 1256 nodes · 1883 edges · 153 communities (113 shown, 40 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 165 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b8e74104`
...
Cohesion: 0.1
Nodes (17): AdherenceCardProps, styles, getGreeting(), HomeGreeting(), HomeGreetingProps, styles, OnboardingPromptProps, StepRowProps (+9 more)
...
Cohesion: 0.12
Nodes (15): NextWorkoutCardProps, styles, EMPTY_DASHBOARD, ExerciseAPI, extractFirstName(), HomeNavigationProp, HomeScreen(), HomeScreenProps (+7 more)

### Community 16 - "Community 16"
Cohesion: 0.12
Nodes (12): Props, styles, Props, styles, Author, FeedPost(), Props, styles (+4 more)
...
Cohesion: 0.2
Nodes (3): of(), WorkoutExecutionLogRepository, HomeAggregatorService
...
- **Why does `of()` connect `Community 22` to `Stats & Dashboard Types`, `Stats Service & Periods`, `Community 46`, `Community 20`, `Community 21`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `Post` connect `Community 46` to `Community 16`?**
