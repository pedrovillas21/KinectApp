# Graph Report - Kinect  (2026-05-28)

## Corpus Check
- 139 files · ~63,184 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 764 nodes · 1024 edges · 78 communities (55 shown, 23 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 62 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `00c89c06`
...
9. `formatNumberPtBR()` - 7 edges
10. `Design System Specification: High-Performance Athleticism` - 7 edges
...
Cohesion: 0.05
Nodes (41): styles, styles, styles, styles, styles, AppHeader(), AppHeaderProps, styles (+33 more)
