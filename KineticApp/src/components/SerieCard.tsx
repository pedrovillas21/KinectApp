...
export default function SerieCard({
  ...
  const cardOuterStyle = [styles.card, isActive && styles.cardActive];
      ...
      <View style={cardOuterStyle}>
        ...
        <View style={styles.inputsRow}>
          <View style={styles.inputCol}>
            ...
            <TextInput
              style={[styles.inputBox, isActive ? styles.inputBoxActive : styles.inputBoxInactive]}
              value={weightValue}
...
const styles = StyleSheet.create({
  outerContainer: { flexDirection: 'row', marginBottom: 16 },
  activeGlow: {
    width: 4,
  ...
  inactiveIndicator: { width: 4, backgroundColor: 'transparent' },
  card: {
    flex: 1,
  ...
  checkButtonCompleted: { backgroundColor: '#2A2A2A' },
  checkTextCompleted: { color: COLORS.neonBlue, fontSize: 16, fontWeight: 'bold' },
  checkTextActive: { color: '#666', fontSize: 16 },
  ...
  inputBox: { height: 52, borderRadius: 8, color: '#FFF', fontSize: 20, fontWeight: 'bold' },
  inputBoxActive: { backgroundColor: 'transparent', borderWidth: 1, borderColor: COLORS.neonBlue },
  inputBoxInactive: { backgroundColor: '#242424', color: '#666' },
});
