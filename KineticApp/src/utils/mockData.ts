...
export const DAY_B: ExerciseItem[] = [
...
export const DAY_C: ExerciseItem[] = [
...
export const WORKOUT_MAP: Record<string, { data: ExerciseItem[]; title: string; subtitle: string; tag: string }> = {
